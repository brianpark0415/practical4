...
// changing the value of a[1] should not change the value of the second
// element of b as it is merely a copy of 'a'
// the problem arose from the fact that 'b' became 'a' instead of
